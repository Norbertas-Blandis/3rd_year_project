    ...
    var body: some View {
        ...
        ScrollView{
            VStack{
                ...
                }.modifier(GrayContainerStyle(opacity: 0.1)).frame(height: 400)
    ...
    var body: some View {
        ...
        ScrollView{
            VStack{
                ...
                Spacer()
                VStack{
                    Text("Even more simply:").padding(.top)
                    HStack{
                        Text("'As")
                        TextView(string: $fx).frame(width: 45, height: 30.0)
                        Text("approaches")
                        TextView(string: $fa).frame(width: 45, height: 30.0)}
                    Text("x is approaching a'").padding(.bottom)
